...
export default{
  ...
  methods:{
    filterMovie(){
      ...
      axios.get('https://api.themoviedb.org/3/search/movie?api_key=756ab663684b23166a50d98c73cd1472&query=' + store.movieName) /*&query=ritorno+al+futuro */
    .then(res=> {
 ...
 //chiamata API per le serie associate al titolo che cerco
 axios.get('https://api.themoviedb.org/3/search/tv?api_key=756ab663684b23166a50d98c73cd1472&query=' + store.movieName)
    .then(res=> {
...
<template>
  <AppHeader @search="filterMovie()"></AppHeader>
  <AppLayout></AppLayout>
</template>
